...
<html>
    ...
    <body>
        <h2 class="judul">Kuliner yang ada di Bandung</h2>
            ...
            <a href="tdbandung.php">tambah data</a>
            ...
            <?php
                ...
                <tr>
                    ...
                    <td><a href='editbandung.php?kode=$data[id]'>Edit</a></td> 
            ...
            <?php
            if (isset($_GET['kode'])){
                mysqli_query($kon,"delete from bandung where id='$_GET[kode]'");

                echo "<script>alert('data telah terhapus');</script>";
                echo "<meta http-equev=refresh content=0;URL='bandungadmin.php'>";
            }
            ?>
