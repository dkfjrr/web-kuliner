<?php
include "koneksi.php";
$sql=mysqli_query($kon,"select * from bandung where id='$_GET[kode]'");
...
<html>
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="text" name="nama_kuliner" value="<?php echo $data['nama_kuliner'];?>"></td>
        </tr>
        <tr>
...
<a href="kulineradmin.php">kembali</a>

<?php
    include "koneksi.php";

    if(isset($_POST['proses'])){
        mysqli_query($kon,"update bandung set
        nama_kuliner = '$_POST[nama_kuliner]',
        keterangan = '$_POST[keterangan]'
        where id = '$_GET[kode]'");

        echo ("Data Telah Diubah");
        echo "<meta http-equev=refresh content=0;URL='kulineradmin.php'>";
    }
?>
